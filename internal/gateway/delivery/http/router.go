...
func NewRouter(log *slog.Logger, core, document, postgres healthChecker, maxAuth *maxauth.InitDataVerifier, webhookAuth *maxauth.WebhookVerifier, sessions *auth.Manager, inbox webhookInbox) http.Handler {
