...
const (
	...
	CoreService_GetGroupBudgetSummary_FullMethodName = "/delim.core.v1.CoreService/GetGroupBudgetSummary"
...
type CoreServiceClient interface {
	...
	GetGroupBudgetSummary(ctx context.Context, in *GetGroupBudgetSummaryRequest, opts ...grpc.CallOption) (*GetGroupBudgetSummaryResponse, error)
...
func (c *coreServiceClient) GetGroupBudgetSummary(ctx context.Context, in *GetGroupBudgetSummaryRequest, opts ...grpc.CallOption) (*GetGroupBudgetSummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGroupBudgetSummaryResponse)
	err := c.cc.Invoke(ctx, CoreService_GetGroupBudgetSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServiceServer interface {
	...
	GetGroupBudgetSummary(context.Context, *GetGroupBudgetSummaryRequest) (*GetGroupBudgetSummaryResponse, error)
...
func (UnimplementedCoreServiceServer) GetGroupBudgetSummary(context.Context, *GetGroupBudgetSummaryRequest) (*GetGroupBudgetSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGroupBudgetSummary not implemented")
}
...
func _CoreService_GetGroupBudgetSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGroupBudgetSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServiceServer).GetGroupBudgetSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoreService_GetGroupBudgetSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServiceServer).GetGroupBudgetSummary(ctx, req.(*GetGroupBudgetSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetGroupBudgetSummary",
			Handler:    _CoreService_GetGroupBudgetSummary_Handler,
		},
		{
